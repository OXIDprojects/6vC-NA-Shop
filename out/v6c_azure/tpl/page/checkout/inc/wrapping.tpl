[{*--
  ...
  *		Replace hard-coded 0,00 with proper formatting
--*}]
                                    ...
                                    <td>
                                        <ul id="wrapp_[{$smarty.foreach.wrappArt.iteration}]">
                                            <li>
                                                ...
                                                <label for="wrapping_[{$basketindex}]">[{ oxmultilang ident="PAGE_CHECKOUT_WRAPPING_NONE" }]</label><strong>[{ $oViewConf->v6cFormatCurrency(0) }]</strong>
                                            </li>
                                            ...
                                            [{foreach from=$oView->getWrappingList() item=wrapping name=Wraps}]
                                                <li>
                                                    ...
                                                    <strong>[{$wrapping->getFPrice()}]</strong>
                                                </li>
                        ...
                        [{foreach from=$oCardList item=card name=GreetCards}]
                            <li>
                                <p class="clear">
                                    ...
                                    <label for="chosen_[{$card->oxwrapping__oxid->value}]">[{$card->oxwrapping__oxname->value}] <strong>[{$card->getFPrice() }]</strong></label>
                                </p>
