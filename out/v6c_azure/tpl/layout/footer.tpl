[{*--
  ...
  *		Added link to footer copyright logo
--*}]
...
[{block name="footer_main"}]
    ...
    <div id="footer">
        ...
        <div class="copyright">
            <a href="[{oxmultilang ident="OXID_ESALES_URL"}]" target="_blank"><img src="[{$oViewConf->getImageUrl('logo_small.png')}]" alt="[{oxmultilang ident="OXID_ESALES_URL_TITLE"}]"></a>
        </div>
        <div class="text">
