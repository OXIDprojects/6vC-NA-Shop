[{*--
  * SUMMARY OF V6C MODS:
  *		Change address layout to NA standard.
  *		Display total price of articles w/o tax for NA orders
  *		Do not display article vats for NA orders
  *		Summarize tax(es) on total order price for NA orders
--*}]
    ...
    <tr>
        ...
        [{ if $edit }]
            ...
            <td class="edittext" height="15">
            	[{*--- BEGIN MODS ---*}]
            	[{if $edit->v6cIsTaxGlobal() }][{ oxmultilang ident="V6C_GENERAL_CARTCOST" }][{else}][{ oxmultilang ident="GENERAL_IBRUTTO" }][{/if}]
            	[{*--- END MODS ---*}]
            </td>
            ...
            [{*--- BEGIN MODS ---*}][{if !$edit->v6cIsTaxGlobal() }][{*--- END MODS ---*}]
            <tr>
