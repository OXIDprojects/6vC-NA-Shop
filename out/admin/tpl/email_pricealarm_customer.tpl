[{*-- 
  * SUMMARY OF V6C MODS:
  *		Remove all currency signs: $currency->sign
--*}]
...
<br>
[{ oxmultilang ident="EMAIL_PRICEALARM_CUSTOMER_ITEM1" }] [{ $oPriceAlarm->getTitle() }] [{ oxmultilang ident="EMAIL_PRICEALARM_CUSTOMER_ITEM2" }] [{ $oPriceAlarm->getFProposedPrice() }]
[{ oxmultilang ident="EMAIL_PRICEALARM_CUSTOMER_ITEM3" }] [{ $oPriceAlarm->getFPrice() }] [{ oxmultilang ident="EMAIL_PRICEALARM_CUSTOMER_ITEM4" }]<br>
<br>
