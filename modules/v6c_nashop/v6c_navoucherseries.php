 ...
 */
class v6c_naVoucherSeries extends v6c_naVoucherSeries_parent
{
	/////////////////////// OVERRIDES ////////////////////////////
    ...
    /**
    * Returns formatted voucher value
    *
    * @return string
    */
    public function v6cGetFValue($oCur = null)
    {
        if (!isset($oCur)) $oCur = oxConfig::getInstance()->getActShopCurrencyObject();

        if ($this->oxvoucherseries__oxdiscounttype->value == "absolute")
            return oxLang::getInstance()->formatCurrency( $this->oxvoucherseries__oxdiscount->value, $oCur );
        else
            return (string)$this->oxvoucherseries__oxdiscount->value . '%';
    }
